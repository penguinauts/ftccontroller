...
@Config
@Autonomous(name="Auto Blue - 6 Ball", group="Blue Side")
public class OptimizedBlueAuto extends LinearOpMode {
    ...
    public static double BACK_TO_RAMP_INCHES          = 8.0;
    public static double FINAL_FORWARD_TO_RAMP_INCHES = 25.0;

    // -----------------------------
    // TURN ANGLES (TUNABLE)
    // -----------------------------
    public static double TURN_TO_INTAKE = -44.5;
    public static double TURN_TO_SHOOT = 64.0;
