...
@Config
@Autonomous(name="Auto Red - 6 Ball", group="Red Side")
public class Auto_Red_6Ball extends LinearOpMode {
    ...
    // DISTANCES (TUNABLE)
    // -----------------------------
    public static double BACK_UP_FROM_START_INCHES    = 38.0;
    public static double FORWARD_AFTER_TURN_INCHES    = 21.0;
    public static double SLOW_FORWARD_INTAKE_INCHES   = 8.0;
    public static double BACK_TO_RAMP_INCHES          = 22.0;
    public static double FINAL_FORWARD_TO_RAMP_INCHES = 30.0;
    ...
    // -----------------------------
    public static double TURN_TO_INTAKE =  54.0;   // was +46 for Blue
    public static double TURN_TO_SHOOT = -62.0;   // was +51 for Blue
...
//        Robot.turnDegrees(this, TURN_2_DEGREES, DRIVE_POWER_TURN_2, Robot.INCHES_PER_90_DEG);
        ...
        Robot.safeWait(200);
        Robot.shooter.setVelocity(SHOOTER_FIRE_VELOCITY + 25);
