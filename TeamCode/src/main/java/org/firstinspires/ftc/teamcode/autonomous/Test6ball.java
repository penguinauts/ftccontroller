...
@Config
@Autonomous(name="Blue-Test-6Ball", group="Blue Side")
public class Test6ball extends LinearOpMode {
    ...
    public static double SLOW_FORWARD_INTAKE_INCHES   = 12.0;
    public static double BACK_TO_RAMP_INCHES          = 20.0;
    public static double FINAL_FORWARD_TO_RAMP_INCHES = 38.0;

    // -----------------------------
    // TURN ANGLES (TUNABLE)
    // -----------------------------
    public static double TURN_TO_INTAKE = -46.0;
    public static double TURN_TO_SHOOT = 45.0;
    ...
    public static double FINAL_EXIT_2 = -40.0;
    ...
    public void runOpMode() {
        ...
        telemetry.addLine("Blue-Test-6Ball");
        telemetry.update();
...
//        // ============================================================
        Robot.ThreeBallShootingProcess2();
