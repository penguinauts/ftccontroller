...
@Config
@Autonomous(name="V2 Blue", group="Blue Side")
public class V2_Blue extends LinearOpMode {
    ...
    public static double SLOW_FORWARD_INTAKE_INCHES   = 17.0;
    public static double BACK_TO_RAMP_INCHES          = 24.0;
    public static double FINAL_FORWARD_TO_RAMP_INCHES = 39.0;

    // -----------------------------
    // TURN ANGLES (TUNABLE)
    // -----------------------------
    public static double TURN_TO_INTAKE = -46.0;
    public static double TURN_TO_SHOOT = 52.0;
